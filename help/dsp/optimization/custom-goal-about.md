...
自訂目標會定義廣告商達成其業務目標所需的成功事件。 每個使用最佳化目標的套件：[!UICONTROL Highest ROAS - Custom Goal]&quot;或&quot;[!UICONTROL Lowest CPA - Custom Goal]「 」必須包含有助於達成整體最佳化目標的自訂目標。 您可以將自訂目標建立為 *目標* 在Advertising Cloud Search。
...
>* 若要在DSP中使用Analytics事件，請搭配您的 [!DNL Adobe] 帳戶管理員來設定廣告商層級的整合。
