...
* **步調填充策略：** 選擇 *[!UICONTROL Even]* 在整個飛行日期內協調一致，以最大化您的效能目標。

   使用 *[!UICONTROL FrontLoad]* 和 *[!UICONTROL Aggressive Front Load]* 只有在您排定傳送的優先順序時才調整步調，並將花費置於效能最佳化之上，因為這些策略可能會對您所需的效能KPI造成負面影響。
...
* **[!UICONTROL Device Targeting]**:
   ...
   * 不定位 [!UICONTROL Firefox] 和 [!UICONTROL Safari] 因為鎖定目標和測量限制。 請連絡您的 [!DNL Adobe] 帳戶管理員，以取得關於 [!DNL Adobe] 支援 [!DNL Safari ITP].
