...
# Adobe Advertising Cloud廣告需求政策

*上次更新：2021年7月12日*

*針對Adobe Advertising Cloud DSP和Adobe Advertising Cloud Search*

本廣告需求政策（「政策」）規定透過Adobe的Advertising Cloud隨需服務（「服務」）發佈廣告的需求。 本政策已參考Adobe與客戶（「您」）之間使用按需服務的協定而納入。 本政策中使用但本協定中未定義的資本化術語將具有本協定中所述的含義。
...
您透過隨選服務傳送、儲存、顯示、分發或以其他方式提供的所有廣告，必須與Adobe Advertising Cloud廣告規格中包含的廣告規格一致，如經Adobe不時修訂，
...
* **假冒或假冒產品**。廣告不得宣傳或描繪假冒或偽造產品，包括護照或官方文書等假證件。

* **性暗示性暗示**。廣告不得含有或宣傳性暗示內容，包括裸體、色情、成人服務或娛樂，或暗示或明示的描述或語言。
...
* **傳銷計畫**。廣告不得推廣傳銷方案、多層次的營銷機會、連鎖信件或其他「快速致富」方案。 任何包含創收機會的廣告都必須包含對業務模式的完整說明。

* **出售身體部位**。廣告不得促進身體部位或體液的銷售。
...
* **酒**。廣告宣傳或宣傳酒類及酒類公司，必須符合適用法律及自律規則，方可投放。 例如，酒精廣告可能不針對未成年人，而且只能在允許酒精廣告的國家運行。 然而，於任何情況下，任何廣告均不得美化或描繪過量的酒精消費。

* **賭**。包含賭博相關內容的廣告，包括通過推廣賭場、彩票和其他機會遊戲（無論是線上還是線下），只能根據適用法律予以推廣。 然而，廣告不得美化或描繪過度賭博行為，亦不得歪曲賭博的機率或風險。
...
* **禁止的目標定位**。根據下列任一因素（無論已知或推斷），廣告不得鎖定或指向對象：
